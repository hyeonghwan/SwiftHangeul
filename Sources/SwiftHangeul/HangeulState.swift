...
extension HangeulState {
    ...
    private func existFinalConsonant() -> Bool {
    ...
    private func enableDoubleFinalConsonant() -> Bool {
    ...
    /// 모음을 설정하는 메소드
    /// - Parameter ch: 입력 문자
    private func setVowel(_ ch: Character) {
    ...
    private func existFirstFinalConsonant() -> Bool {
    ...
    private func existLastFinalConsonant() -> Bool {
...
extension HangeulState {
    ...
    /// 종성 상태를 설정하는 메서드
    private func setStateFinalConsonant() {
        state = .종성_Turn
